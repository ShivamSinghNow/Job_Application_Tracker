...
import { Cpu, Loader2, Mail, User } from "lucide-react";
...
export default function SignUpPage() {
  ...
  return (
    <div className="min-h-screen bg-background cyber-grid relative flex items-center justify-center px-4">
      ...
      <Card className="relative w-full max-w-md border-border bg-card/80 backdrop-blur-sm dark:bg-card/60 dark:neon-border-cyan">
        ...
        <CardContent className="space-y-6">
          ...
          <div className="grid gap-3">
            <Button
              variant="outline"
              className="w-full border-border hover:bg-muted dark:hover:bg-neon-cyan/10"
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <Button
              type="submit"
              className="w-full bg-primary text-primary-foreground hover:bg-primary/90 dark:bg-neon-cyan dark:text-black dark:hover:bg-neon-cyan/90 dark:neon-glow-cyan"
              disabled={loading}
            >
          ...
          <p className="text-center text-sm text-muted-foreground">
            ...
            <Link href="/auth/signin" className="font-medium text-primary dark:text-neon-cyan hover:underline">
              Sign in
            </Link>
          </p>
        </CardContent>
