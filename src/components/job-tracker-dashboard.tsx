    ...
    <div className="min-h-screen bg-background cyber-grid relative">
      ...
      <div className="relative mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
            ...
            <div className="flex flex-col gap-2">
              ...
              <div className="flex gap-3">
                <div className="relative flex-1">
                  ...
                  <Input
                    type="url"
                    placeholder={hasResume ? "https://example.com/jobs/software-engineer" : "Upload your resume first to start tracking jobs"}
                    value={jobUrl}
                ...
                <Button
                  ...
                  disabled={!jobUrl.trim() || isLoading || !hasResume}
                                ...
                                <div className="min-w-0 space-y-4">
                                  ...
                                  <div className="flex flex-wrap gap-4">
                                    <div className="flex items-center gap-2 text-sm">
                                      <MapPin className="size-4 shrink-0 text-accent dark:text-neon-magenta" />
                                      <span className="text-muted-foreground">{app.location}</span>
                                    </div>
                                    {app.salaryRange && (
                                      <div className="flex items-center gap-2 text-sm">
                                        <DollarSign className="size-4 shrink-0 text-neon-green" />
        ...
        <div className="mt-8 text-center text-sm text-muted-foreground">
          <span className="font-mono dark:text-neon-cyan/60">v0.1.0</span>{" "}<span className="dark:text-neon-magenta/60">{"/"}{"/"}
          </span>{" "}Powered by AI
        </div>
      </div>
    </div>
